...
if __name__ == '__main__':
    ...
    args.add_argument("names", nargs="+",help="Names of the classes to generate / name of the json file without "
    ...
    controller = LevelController(json_path=args.json_path, dtc_path=args.dtc_path, verbose=args.verbose)
